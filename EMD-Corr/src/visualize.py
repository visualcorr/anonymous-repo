...
class Visualization(object):
    ...
    def imagenet_real_visualize_neighbor_explanation(
        ...
        myCmd = "rm -rf /home/user1/Downloads/KNN-ImageNet/tmp/ImageNet-val-50K-clean/[0-4].jpeg"
        os.system(myCmd)
    ...
    def visualize_optimal_plans(
        ...
        for topk_idx, topk_plan in enumerate(topk_plans):
            ...
            tmp_image_path = "/home/user1/Downloads/KNN-ImageNet/sliced_data/tmp.jpeg"
            copyfile(
                "/home/user1/Downloads/KNN-ImageNet/tmp/cub200_test/1.jpeg",
                tmp_image_path,
            )
            ...
            for tile_idx, tile in enumerate(tiles):
                ...
                filename = "/home/user1/Downloads/KNN-ImageNet/sliced_data/tmp_0{}_0{}.png".format(
            ...
            for topk_idx, topk_plan in enumerate(topk_plans):
                ...
                tmp_image_path = (
                    "/home/user1/Downloads/KNN-ImageNet/sliced_data/tmp.jpeg"
                )
                copyfile(
                    "/home/user1/Downloads/KNN-ImageNet/tmp/cub200_test/query.jpeg",
                    tmp_image_path,
                )
                num_tiles = RunningParams.layer4_fm_size * RunningParams.layer4_fm_size
